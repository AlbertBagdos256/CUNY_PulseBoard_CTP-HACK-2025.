    ...
    <div className="p-8 block2">
      <div className="max-w-4xl block">
        ...
        <div className="flex space-x-4 mb-12">
          ...
          <Link to="/dashboard" className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-3 rounded-lg font-medium transition-colors">
            View Results
          </Link>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Link to="/dashboard" className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-200">
